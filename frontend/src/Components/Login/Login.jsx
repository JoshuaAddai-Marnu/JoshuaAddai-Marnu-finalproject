...
const LoginStyled = styled.div`
    ...
    .floating-icons {
        ...
        .icon {
            ...
            &.fa-chart-line { top: 10%; left: 5%; }
            &.fa-credit-card { top: 15%; right: 5%; }
            &.fa-tags { bottom: 10%; left: 5%; }
            &.fa-wallet { bottom: 15%; right: 5%; }
            &.fa-cog { top: 45%; left: 10%; }
            &.fa-sign-out { top: 45%; right: 10%; }
            &.fa-money-bill-trend-up { top: 5%; left: 15%; }
            &.fa-money-bill-transfer { top: 5%; right: 15%; }
            &.fa-money-bill { bottom: 5%; left: 50%; transform: translateX(-50%); }
            &.fa-earth-americas { top: 90%; left: 28%; }
            &.fa-arrow-trend-up { top: 30%; right: 20%; }
            &.fa-bitcoin { bottom: 25%; left: 20%; }
            &.fa-piggy-bank { bottom: 30%; right: 20%; }
            &.fa-youtube { top: 35%; left: 30%; }
            &.fa-cc-visa { top: 40%; right: 30%; }
            &.fa-users-between-lines { bottom: 35%; left: 30%; }
            &.fa-dollar-sign { bottom: 40%; right: 30%; }
            &.fa-sterling-sign { top: 10%; right: 25%; }
            &.fa-calendar { bottom: 10%; right: 25%; }
            &.fa-comment { top: 60%; left: 35%; }
            &.fa-plus { top: 65%; right: 35%; }
            &.fa-trash { bottom: 60%; left: 35%; }
            &.fa-right-from-bracket { bottom: 65%; right: 35%; }
            &.fa-utensils { top: 70%; left: 40%; }
            &.fa-shirt { top: 75%; right: 40%; }
            &.fa-book-open { bottom: 70%; left: 40%; }
            &.fa-bowl-food { bottom: 75%; right: 40%; }
            &.fa-briefcase-medical { top: 80%; left: 45%; }
            &.fa-tv { top: 85%; right: 45%; }
            &.fa-circle-dot { bottom: 80%; left: 45%; }
            &.fa-bullseye { bottom: 85%; right: 45%; }
            &.fa-scale-unbalanced { top: 50%; left: 55%; transform: translateX(-50%); }
            &.fa-hand-holding-dollar { bottom: 90%; right: 50%; transform: translateX(50%); }
        }
    }
